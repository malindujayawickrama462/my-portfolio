...
function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full p-8 flex justify-between items-center text-white z-50 backdrop-blur-md bg-black/30">
      ...
      <div className="flex gap-8 text-sm font-semibold uppercase tracking-widest">
        {['Projects', 'About', 'Contact', 'Education'].map((item) => (
